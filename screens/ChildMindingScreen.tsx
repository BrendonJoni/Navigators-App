// ChildMindingScreen — child minding course
...
const ChildMindingScreen = ({ navigation }: { navigation: any }) => {
        ...
        <View style={styles.glassWrapper}>
          <BlurView intensity={80} tint="light" style={styles.glassBox}>
            <ScrollView contentContainerStyle={styles.scrollContent}>
              <Text style={styles.courseTitle}>Child Minding & Early Care</Text>

              <Text style={styles.sectionTitle}>Overview</Text>
              <Text style={styles.sectionText}>
                This nurturing course prepares learners to care for young children in home or daycare settings. It covers child development, safety, nutrition, and emotional support, with practical guidance for building trust and routine.
              </Text>
              ...
              <Text style={styles.sectionText}>6 Weeks (Includes practical sessions)</Text>

              <Text style={styles.sectionTitle}>Certification</Text>
              <Text style={styles.sectionText}>Certificate in Early Childhood Care issued by the Family Services Council.</Text>

              <Text style={styles.sectionTitle}>Requirements</Text>
              <Text style={styles.sectionText}>Must be 16+ years old. No prior experience required. Passion for working with children encouraged.</Text>
            </ScrollView>
          </BlurView>
        </View>
